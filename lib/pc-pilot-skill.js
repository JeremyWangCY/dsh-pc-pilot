...
## Browser tasks
- Keep one exact \`browser_endpoint\` and \`tab_id\`. \`browser_observe\` is the concise semantic alias of \`browser_state\`; both return raw element tokens plus short \`@eN\` refs. Observe when needed, not as a mandatory extra step after every action.
